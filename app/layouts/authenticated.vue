...
const links = [{ l: 'Visão geral', to: '/aluno' }, { l: 'Meus cursos', to: '/aluno/cursos' }, { l: 'Catálogo', to: '/aluno/catalogo' }, { l: 'Certificados', to: '/aluno/certificados' }, { l: 'Pedidos', to: '/aluno/pedidos' }, { l: 'Perfil', to: '/aluno/perfil' }]
</script>
