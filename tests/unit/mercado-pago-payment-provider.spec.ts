...
describe('MercadoPagoPaymentProvider', () => {
  ...
  it('creates Pix with bearer authentication, idempotency and payer identity', async () => {
    ...
    await provider.createPixPayment({
      ...
      expirationDate: '2026-09-01T18:00:00.000Z', notificationUrl: 'https://example.com/api/webhooks/mercado-pago',
    ...
    expect(JSON.parse(options.body)).toMatchObject({
      transaction_amount: 100, payment_method_id: 'pix', external_reference: 'order-1',
