...
describe('AsaasTransparentPaymentProvider', () => {
  ...
  it('sends the total and installment count for card processing', async () => {
    ...
    expect(body).toMatchObject({ billingType: 'CREDIT_CARD', installmentCount: 6, totalValue: 108.98, remoteIp: '203.0.113.10', creditCardHolderInfo: { postalCode: '64000000', addressNumber: '10' } })
  })
})
