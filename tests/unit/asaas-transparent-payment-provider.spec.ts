...
describe('AsaasTransparentPaymentProvider', () => {
  ...
  it('sends the total and installment count for card processing', async () => {
    ...
    await provider.createCardPayment({
      ...
      creditCardHolderInfo: { name: 'Maria Silva', email: 'maria@example.com', cpfCnpj: '52998224725', postalCode: '64000000', addressNumber: '123', phone: '5586999999999', mobilePhone: '5586999999999' },
    })

    const body = JSON.parse(fetchMock.mock.calls[0]![1].body)
    expect(body).toMatchObject({ billingType: 'CREDIT_CARD', installmentCount: 6, totalValue: 108.98, remoteIp: '203.0.113.10', creditCardHolderInfo: { postalCode: '64000000', addressNumber: '123' } })
  })
})
