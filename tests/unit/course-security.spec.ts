...
const publicationHardening = readFileSync(resolve('supabase/migrations/20260812000100_enforce_course_publication_on_insert.sql'), 'utf8')
describe('course catalog security contracts', () => {
  ...
  it('enforces publication completeness on inserts and updates', () => { expect(publicationHardening).toContain('before insert or update on public.courses') })
})
